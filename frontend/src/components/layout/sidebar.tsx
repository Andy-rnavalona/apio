...
const mainNav: NavItem[] = [
  ...
  { id: "layers",  label: "Projets",      icon: icons.layers },
        ...
        <TooltipTrigger asChild>
          ...
          >
            ...
            {item.badge !== undefined && item.badge > 0 && (
              <span
                className={cn(
                  "absolute top-1.5 right-1.5 w-[7px] h-[7px] rounded-full border",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center w-8 h-8 rounded-xl bg-black mb-2">
        <span className="text-white text-[11px] font-bold tracking-tight leading-none">M</span>
      </div>
